...
public abstract class Account {
	...
	void takeAccountDetails(){
		...
		scanner.nextLine();
		age = accobj.ageCalculation(dob);
		accobj.populateAccounts(accountNumber, accType, name, dob, phone, balance, age);
